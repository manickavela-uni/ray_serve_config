...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in user_defined_protos_pb2_grpc.py depends on'
...
def add_UserDefinedServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('userdefinedprotos.UserDefinedService', rpc_method_handlers)
...
def add_ImageClassificationServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('userdefinedprotos.ImageClassificationService', rpc_method_handlers)
